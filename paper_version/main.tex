...
\begin{figure}
    ...
    \end{minipage}
    \hspace{1cm}
    \includegraphics[scale=0.2]{paper_version/figures/cube_mesh_primal.png}
    \hspace{1cm}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \draw[blue, -to] (0,0) -- (0.7,0) node[below]{\small $y$};
        \end{tikzpicture}
        \includegraphics[scale=0.2]{paper_version/figures/E-field_lambda-1.png}\hspace{0.6cm}
        \includegraphics[scale=0.2]{paper_version/figures/B-field_lambda-1.png}
...
\begin{figure}
    ...
    \end{minipage}
    \hspace{1cm}
    \includegraphics[scale=0.2]{paper_version/figures/primal_mesh_bend.png}
    \hspace{1cm}
