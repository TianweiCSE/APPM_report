...
assumption $\rho = \sum_* q_*n_* \approx 0$ is justified, which yields the limit model,
formally obtained by setting the rescaled Debye length $\lambda$ to zero in \eqref{resc}:
\begin{center}
