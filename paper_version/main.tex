...
The plasma fills $\Omega_I$ where the Euler system lies and thus the boundary of plasmas lies on $\partial\Omega_P$. We consider the physical scenario where plasmas are confined with the solid insulator. Therefore, the interface $\Gamma_W$ is treated as reflective walls where fluid particles are bounced back while keeping the tangential velocity and energy unchanged. The contact boundary $\Gamma_C$ is where the plasma and energy flow across, modelled by, for the sake of simplicity, open boundaries, namely they are free to flow through. \todo{Discussion the more realistic electrode model}
...
\begin{minipage}{0.45\textwidth}
    ...
    \draw[very thick] (O1) circle (1) node[blue] {Electrode};
...
\begin{minipage}{0.49\textwidth}
    \resizebox{1.1\textwidth}{!}{ \begin{tikzpicture}
        ...
        \draw[gray] (A2) -- node[above]{\textbf{Insulator $\Omega_I$}} node[black, below]{$\Gamma_W$} (B2);
        \draw[gray] (A3) -- node[below]{\textbf{Insulator $\Omega_I$}} node[black, above]{$\Gamma_W$} (B3);
